...
**Stored Javascript**
Auf dem DB server lassen sich eigenen Funktionen in der system.js collection hinterlegen, die dann im map-reduce Verfahren (oder anderen Aggregationen), in where Bedingungen bei Abfragen und in eval calls benutzt werden können.
